      ...
      <main className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {plans.map((plan, index) => (
            <Card
              key={plan.name}
              className={`relative bg-white/10 backdrop-blur-sm border text-white ${plan.popular ? "border-purple-400 shadow-lg shadow-purple-500/20" : "border-white/20"} hover:bg-white/15 transition-all duration-300`}
            >
              {plan.popular && (
