            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2 text-white">
                ...
                <span className="text-sm font-medium">{user?.name}</span>
                            ...
                            <Button variant="outline" onClick={logout} className={`flex items-center space-x-2 ${theme === 'dark' ? 'border-white/20 text-white hover:bg-white/10' : 'border-white/30 bg-transparent text-white hover:bg-white/10 border-2'}`}>
