    ...
    >
      ...
      <main className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8 animate-slide-up-delay">
          ...
          <Link to="/wallet">
            <Card
              className={`${theme === "dark" ? "bg-white/5 border-white/10 text-white" : "bg-black/5 border-black/10 text-black"} backdrop-blur-sm hover:scale-105 transition-transform cursor-pointer`}
            >
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-1 text-sm">
                {phoneNumbers.slice(0, 3).map((number) => (
                  <div
                    key={number.id}
                    className={`${theme === "dark" ? "text-gray-300" : "text-gray-300"}`}
                  >
                ...
                {phoneNumbers.length > 3 && (
                  <div
                    className={`${theme === "dark" ? "text-gray-400" : "text-gray-400"} text-xs`}
                  >
