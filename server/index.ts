...
import {
  ...
  getSubAccountStats,
  updateSubAccountStats,
} from "./routes/sub-account-management";
...
export function createExpressApp() {
  ...
  app.post("/api/twilio/webhook", receiveSMS);
  ...
  app.post("/api/wallet/add-funds", addFunds);
  app.get("/api/wallet/transactions", getWalletTransactions);
  app.post("/api/wallet/deduct", deductFunds);

  // Sub-account management routes
  app.get("/api/sub-account-management/:subAccountId", getSubAccountDetails);
  app.get("/api/sub-account-management/stats", getSubAccountStats);
  app.post("/api/sub-account-management/update-stats", updateSubAccountStats);
